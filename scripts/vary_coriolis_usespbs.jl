...
parameter_space = Dict(
    "architecture" => "GPU",
    "f" => [1e-6, 2e-6, 4e-6, 8e-6, 1e-5, 2e-5, 4e-5, 8e-5],                                                                                                 
    "g" => 10.0,#gravitational acceleration                                                                                                 
    "convection_timescale" => 14400.0,                                                                                 
    "convection_critical_height"=> 40.0,                                                                          
    "heating_amplitude"    => 5e8,                                                                                                                                                                 
    ...
    "convective_radius"    => 30_000.0,                                                                                       
    "relaxation_parameter" => 1.0/(0.8*86400.0), # 1/relaxation timescale                                                                           
    "Lx" => 48e6, #domain                                                                                                                        
    "Ly" => 48e6,
    "Nx" => 6000,
    "Ny" => 6000,
