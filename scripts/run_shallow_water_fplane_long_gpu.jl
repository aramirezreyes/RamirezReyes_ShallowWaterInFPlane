...
relaxation_parameter = 2.0/86400 #2.0/3600.0
...
simulation = Simulation(model, Δt = 10, stop_time = 864000)
 ...
 simulation.output_writers[:fields] =
     NetCDFOutputWriter(
         ...
         (h = h , v = v , u = u, isconvecting = isconvecting),
           filepath = joinpath(ENV["SCRATCH"], "shallow_water_example_long_gpu.nc"),
