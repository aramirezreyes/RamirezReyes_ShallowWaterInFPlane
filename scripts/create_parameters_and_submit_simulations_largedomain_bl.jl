...
parameter_space = Dict(
    "architecture" => "GPU",
    "f" => [5f-3, 1f-4, 5f-5, 3f-5, 1f-5, 5f-6, 0.0],# coriolis parameter5e-4 #5e-4
    ...
    "q0"    => [5f11,1f11,5f10,1f10],#convective heating 1.0e9 #originally 9 for heating, -8 for cooling convective heating
