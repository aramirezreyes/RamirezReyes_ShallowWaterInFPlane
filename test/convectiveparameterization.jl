...
@testset "Detect convecting events" begin
    ...
    update_convective_events!(
        ...
        0,
        0,
    ) #should start new convective event because height is still below the threshold
    ...
    update_convective_events!(
        ...
        0,
        0,
    ) #should convect because height is still below the threshold
